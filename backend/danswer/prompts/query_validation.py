...
{QUESTION_PAT.upper()} WorldPay Chatbot is unreachable.
```
{THOUGHT_PAT.upper()} The system searches documents related to WorldPay Chatbot being unreachable. \
Assuming the documents from search contains situations where WorldPay Chatbot is not reachable and \
